"""Thread-safe task store: in-memory dict persisted to .coleslaw/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.coleslaw/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".coleslaw" / "tasks.json"
