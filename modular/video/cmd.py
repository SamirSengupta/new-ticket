"""
Video slash-command wizard for ColeSlaw.
...
COMMAND_DEFS is the plug-in interface: coleslaw.py discovers
...
# ── Minimal ANSI helpers (self-contained, no import from coleslaw) ────────
_C = {
...
def cmd_video(args: str, _state, config) -> bool:
    ...
    _here        = os.path.dirname(os.path.abspath(__file__))   # .../coleslaw/video/
    _pkg_dir     = os.path.dirname(_here)                        # .../coleslaw/
    _versions_dir = os.path.dirname(_pkg_dir)                    # .../coleslaw_versions/
...
# ── Plugin interface ───────────────────────────────────────────────────────────
# coleslaw.py discovers slash commands via this dict.
