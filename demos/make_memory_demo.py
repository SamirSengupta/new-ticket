#!/usr/bin/env python3
"""
Generate animated GIF demo of coleslaw Memory system using PIL.
...
def build_scenes():
    ...
    # ════════════════════════════════════════════════════════════════════
    add(BANNER1 + [
        divider("Session 1  —  first time using ColeSlaw"),
        None,
        prompt_line(cursor=True),
    ], 900)

    base1 = BANNER1 + [divider("Session 1  —  first time using ColeSlaw"), None]
