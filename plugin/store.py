...
USER_PLUGIN_DIR  = Path.home() / ".coleslaw" / "plugins"
USER_PLUGIN_CFG  = Path.home() / ".coleslaw" / "plugins.json"

def _project_plugin_dir() -> Path:
    return Path.cwd() / ".coleslaw" / "plugins"

def _project_plugin_cfg() -> Path:
    return Path.cwd() / ".coleslaw" / "plugins.json"
