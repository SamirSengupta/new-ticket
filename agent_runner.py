...
* Iteration history is persisted to ~/.coleslaw/agents/<name>/log.jsonl.
...
_USER_TEMPLATES_DIR = Path.home() / ".coleslaw" / "agent_templates"
...
_LOG_DIR = Path.home() / ".coleslaw" / "agents"
