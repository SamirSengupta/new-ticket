...
<div align=center>
<center style="color:#000000;text-decoration:underline">Passerelle Telegram : contrôlez ColeSlaw depuis votre téléphone</center>
 </div>
...
ColeSlaw : une réimplémentation Python de Claude Code, **légère** et **facile à utiliser**, avec **prise en charge de pratiquement tous les modèles**, notamment Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek, MiniMax, ainsi que des modèles open source locaux via Ollama ou tout endpoint compatible OpenAI.
...
**ColeSlaw** réimplémente la même boucle centrale dans un Python lisible : léger, modifiable, multi-fournisseur et exécutable localement. Il conserve l’essentiel et supprime la complexité inutile. Voir ici pour plus de détails : [English version](https://github.com/SamirSengupta/ColeSlaw/blob/main/docs/comparison_claude_code_vs_nano_v3.03_en.md) and [Chinese version](https://github.com/SamirSengupta/ColeSlaw/blob/main/docs/comparison_claude_code_vs_nano_v3.03_cn.md)
