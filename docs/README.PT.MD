...
<div align=center>
<center style="color:#000000;text-decoration:underline">Ponte do Telegram: controle o ColeSlaw pelo celular</center>
 </div>
...
ColeSlaw: uma reimplementação em Python do Claude Code, **leve** e **fácil de usar**, com **suporte para praticamente qualquer modelo**, como Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek, MiniMax e modelos abertos locais via Ollama ou qualquer endpoint compatível com OpenAI.
...
| Dimensão | OpenClaw (TypeScript) | ColeSlaw (Python) |
|-----------|----------------------|---------------------|
