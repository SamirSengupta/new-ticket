...
<div align=center>
<center style="color:#000000;text-decoration:underline">Telegramブリッジ：スマホからColeSlawを操作</center>
 </div>
...
ColeSlaw は、Claude Code を Python で再実装した **軽量** かつ **使いやすい** ツールで、Claude、GPT、Gemini、Kimi、Qwen、Zhipu、DeepSeek、MiniMax、さらに Ollama や OpenAI 互換エンドポイント経由のローカルなオープンソースモデルなど、**ほぼあらゆるモデル** をサポートします。
...
| 項目 | OpenClaw (TypeScript) | ColeSlaw (Python) |
|-----------|----------------------|---------------------|
