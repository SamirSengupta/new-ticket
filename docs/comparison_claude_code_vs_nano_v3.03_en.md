# Claude Code vs ColeSlaw v3.03: Comparative Analysis

## Overview

| Dimension | Claude Code (TypeScript) | ColeSlaw (Python) |
|-----------|--------------------------|---------------------------|
...
**ColeSlaw**: `rich` library, Markdown syntax highlighting — simple but sufficient
...
5. **Markdown Skills** — Custom skills via `~/.coleslaw/skills/*.md` without touching source code
