"""
commands/session.py — Session management commands for ColeSlaw.
...
def cmd_cloudsave(args: str, state, config) -> bool:
    ...
    if sub == "list":
        info("Fetching your coleslaw sessions from GitHub Gist…")
        ...
        for s in sessions:
            ...
            desc = strip_session_tag(s["description"])
